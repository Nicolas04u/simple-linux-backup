...
REMOTE_DEST="backup_user@192.168.1.100:/home/backup_user/storage/${CLIENT_ID}/"
DB_NAME="db_cliente"
...
rsync -avz -e "ssh -o StrictHostKeyChecking=accept-new" "${STAGING_DIR}/${ARCHIVE_NAME}" "${REMOTE_DEST}"
